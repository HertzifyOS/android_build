...
ifneq ($(HERTZIFY_BUILD),)
include vendor/hertzify/config/BoardConfigHertzify.mk
endif
...
ifneq ($(HERTZIFY_BUILD),)
ifneq ($(wildcard device/hertzify/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/hertzify/sepolicy/common/sepolicy.mk)
endif
endif
